...
(function () {
  ...
  for (let i = 0; i < 6000; i++) {
    let x = sizeFactor * (Math.random() * 2 - 1);
    let y = sizeFactor * (Math.random() * 2 - 1);
    let z = sizeFactor * (Math.random() * 2 - 1);
  ...
  sprite = new THREE.TextureLoader().load(url + "texture/star 3.png");
